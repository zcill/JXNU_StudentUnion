...
+ (void)showErrorHudAddTo:(UIView *)view animated:(BOOL)animated text:(NSString *)text {
    
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:view animated:animated];
    hud.labelText = text;
    hud.mode = MBProgressHUDModeCustomView;
    UIImageView *error = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"hud_error"]];
